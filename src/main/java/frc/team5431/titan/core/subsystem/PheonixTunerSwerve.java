 ...
 * device types.
 * <h3>
 * This is intened to be utilized inside of titan util only.
 * </h3>
 * Utilized by {@link TitanSwerve
 */

public class PheonixTunerSwerve extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> {
